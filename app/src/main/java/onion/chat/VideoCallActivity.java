...
public class VideoCallActivity extends AppCompatActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		if (checkSelfPermission(Manifest.permission.CAMERA) != PackageManager.PERMISSION_GRANTED
				||
				(ContextCompat.checkSelfPermission(VideoCallActivity.this, Manifest.permission.WRITE_EXTERNAL_STORAGE) != PackageManager.PERMISSION_GRANTED)
		) {
		...
		mImageView = findViewById(R.id.outgoingVideo);

		mButtonOpenCamera1.setOnClickListener(v -> {
		...
		mButtonStreamVideo.setOnClickListener(v -> {
		...
		mButtonTStopStreamVideo.setOnClickListener(v -> {


			if (mCodec != null) {

				Toast.makeText(VideoCallActivity.this, " остановили стрим", Toast.LENGTH_SHORT).show();
