...
public class ServerBlog {
    private static ServerBlog instance;
    String socketName;
    ...
    public ServerBlog(Context context) {
    ...
    public static ServerBlog getInstance(Context context) {
        if (instance == null) {
            instance = new ServerBlog(context);
        }
        return instance;
    }
