...
public class TorBlog {
    ...
    private static TorBlog instance = null;

    public static TorBlog getInstance(Context context) {
        if (instance == null)
            instance = new TorBlog(context);
        return instance;
    }
    ...
    public TorBlog(final Context context) {

        final ServerBlog server = ServerBlog.getInstance(context);
